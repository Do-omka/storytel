...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  var toblur = document.querySelectorAll('.faq-item:last-child');

  if ("IntersectionObserver" in window) {
    toblur.forEach(function (i) {
    ...
    document.querySelectorAll('.faq-item:last-child').forEach(function (faq) {
      blurObserver.observe(faq);
    });
  } else {
    blurOnScroll.forEach(function (faq) {
